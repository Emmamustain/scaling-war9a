...
import { CalendarDateRangePicker } from "@/components/Compounds/dashboard/date-range-picker";
import { Overview } from "@/components/Compounds/dashboard/overview";
import { RecentSales } from "@/components/Compounds/dashboard/recent-sales";
                  ...
                  <Tabs defaultValue="overview" className="space-y-4">
                    ...
                    <TabsContent value="overview" className="space-y-4">
                      ...
                      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                        <Card className="col-span-4 bg-neutral-800 text-white">
                          <CardHeader>
                        ...
                        <Card className="col-span-3 bg-neutral-800 text-white">
                          <CardHeader>
